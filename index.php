        ...
        <div class="row ">
            <div class="container-fluid txt-wh">
                ...
                <div class="wrap-iconos">
                    ...
                    <p class="text-justify f-s-20">Lacteos la laja te ofrece distintos productos lácteos de alta calidad
                        elaborados por manos guanajuatenses, en la región
                        Laja-Bajío.</p>
                </div><br>
                    ...
                    <div class="row  icons">
                        <div class="media tooltip-box" onClick="jascript:verReceta(1)">
                            ...
                            <div class="media-body">
                                ...
                                <p class="text-justify f-s-20">Amplia variedad de quesos, así como distintas
