...
--
-- Host: 127.0.0.1
-- Generation Time: Nov 27, 2021 at 12:44 AM
...
(29, 'Comentar', '2021-11-26', 1, 'Jose'),
(30, 'Muy bueno.', '2021-11-26', 4, 'Omar');
...
(27, 'icidomar15@gmail.com', 'Omar Arturo', 'Laguna de teminos 14', 37800, 'León', 'Guanajuato', 'México', 2147483647, '2021-11-26 08:42:35', '2021-11-27 08:42:35', 1, 'Yoghurt Lari', '0.1', '117');
...
('Queso Oaxaca', '1 KG', 100, 'img-1', 0.1, 1, 1, 64, 'Queso tipo oaxaca hecho puro de vaca.', 1),
('Yoghurt Lari', '4 KG', 150, 'img-2', 0.1, 2, 1, 65, 'Yoghurt hecho a base de leche de cabra en distintos sabores.', 2),
('Queso Panela la laja\r\n', '1.6 KG', 50, 'img-3', 0.2, 1, 1, 40, 'Queso panela bajo en calorias, hecho con leche pura de vaca.', 3),
('Boli Lari', '1 Kg', 40, 'img-4', 0.05, 2, 1, 14, 'Boli Lari', 4),
('Queso Oaxaca', '200 GR', 30, 'img-5', 0, 1, 1, 1, 'Queso tipo oaxaca hehco puro de vaca. El queso Oaxaca es el queso más internacional de México y el más apreciado por su textura elástica única y su sabor delicado y suave. Este queso resulta ideal para fundir o deshebrar, por el que también se le llama queso de hebra. Por esta razón, es el queso óptimo para la preparación de algunas de las especialidades gastronómicas mexicanas.', 5),
('Queso Oaxaca Rallado La Laja', '1 KG', 80, 'img-6', 0, 1, 1, 1, 'Queso oaxaca rayado hecho puro de vaca, ideal para antojitos mexicanos. El queso rallado es un indispensable en nuestras cocinas. Es una de las formas más habituales de consumirlo. Su amplia utilidad en recetas lo convierten en uno de los reyes de las neveras. Se obtiene mediante el proceso de rallar o trocear en virutas el queso, facilitando su manipulación. El queso rallado se puede obtener casi de cualquier tipo de queso, siendo el de mozzarella uno de los más famosos.', 6),
('Queso Panela La La Laja', '800 GR', 20, 'img-7', 0, 1, 1, 1, 'Que panela, hecho puro de vaca, presentacion de 800 gramos. EL queso Panela es ideal para platillos bajos en calorias, puedo conmbinarlo con ensaldas y disfrutar el fresco sabor del queso de granja.', 7),
...
('Yoghurt Lari', '1 L', 38, 'img-15', 0, 2, 1, 0, 'Yoghurt de un litro, puro de vaca, sabor. Sabor piña, perfecto para beber y acompañar tus desayunos.', 15),
...
--
ALTER TABLE `compra`
  MODIFY `id_compra` int(15) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=28;
